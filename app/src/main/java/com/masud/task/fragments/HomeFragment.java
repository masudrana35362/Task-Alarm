package com.masud.task.fragments;
...
import  com.masud.task.data.MyTask;
import  com.masud.task.data.TaskViewModel;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            query.addValueEventListener (new ValueEventListener () {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot d : dataSnapshot.getChildren ()) {
                        try {
                            if (HasActiveNetworkConnection (requireContext())) {
        ...
        taskViewModel.getAllTasks ().observe (getViewLifecycleOwner(), myTasks -> {
